        ...
        <div className="max-w-screen-lg mx-auto p-6">
            ...
            <div className="mt-6" ref={resultRef}>
                ...
                {searchResults.map(result, index => (
                    ...
                    <img src={`${BASE_URL}/${result.image_path}`} alt={`Cờ ${result.country_name}`} onError={handleImageError} className="w-full h-40 object-cover" />
                    <div className="p-4">
            ...
            <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50" onClick={handleCloseModal}>
                ...
                <div className="p-5 flex flex-col md:flex-row gap-5">
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tr className="even:bg-gray-50">
                            <th className="p-2 text-left font-semibold text-gray-600 border-b border-gray-200">Điện thoại (/1000 người)</th>
            ...
            {/* Giới thiệu */}
            <section className="py-16 bg-gradient-to-b from-white to-blue-50 rounded-lg">
